                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer form-group text-right m-0">
                                                        <div class="d-flex justify-content-end">
                                                            ...
                                                            <a href="#"
                                                                class="btn btn-success mr-2 toastReturnItemRequest">
...
<script>
    ...
    // Add a row when the "Add" button is clicked
    ...
    $(document).on('click', '#items_table .delete-row', function () {
    ...
    // Reset all rows when the "Reset" button is clicked
    $(document).on('click', '#resetRows', function () {
        var tableBody = $('#items_table tbody');
        var originalRow = tableBody.find('tr:first').clone();

        // Remove all existing rows
        tableBody.empty();

        // Add the original row back to the table
        tableBody.append(originalRow);
    });
});
